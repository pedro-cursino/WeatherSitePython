...
// Usa a geolocalização do navegador(mas se não tiverm, manda mensagem de erro)
...
// Pega as coordenadas da geolocalização(latitude, logitude, idioma, celcius e chave do site)
...
// Pesquisa a cidade quando clica no icone
search_button.addEventListener('click', function () {
    searchResults(search_input.value)
})

// Pesquisa a cidade quando clica no Enter
...
// Procura as informações da cidade(cidade, idioma, celcius, chave do site), se der errado manda msg
...
// Atualiza as informações com as novas informações
...
function dateBuilder(d) {
    ...
    let date = d.getDate();
    let month = months[d.getMonth()]; //getMonth: 0-11
...
// Texto em baixo do nublado
function capitalizeFirstLetter(string) {
    return string.charAt(0).toUpperCase() + string.slice(1);
}

// Fundo cinza
window.addEventListener("load", document.body.style.background = '#313338');